...
public class GsonObjectTreeNavigator implements ObjectTreeNavigator {
	...
	public String getString(String fieldPath, String defaultValue) {
		...
		return (_s9.is("EQ") && (current == null)) || (_s9.is("NE") && (current != null)) ? defaultValue : current.isJsonNull() ? null : current.isJsonPrimitive() ? current.getAsString() : current.toString();
	}

	@Override
	public ObjectTreeNavigator getNavigator(String fieldPath) {
		JsonElement current = getJsonElement(fieldPath);
		return (_s11.is("EQ") && (current == null)) || (_s11.is("NE") && (current != null)) ? null : new GsonObjectTreeNavigator(current);
	}
	...
	public Iterable<prototype.ObjectTreeNavigator> getIterable(String fieldPath) {
		...
		return new Iterable<prototype.ObjectTreeNavigator>() {
			...
			public Iterator<prototype.ObjectTreeNavigator> iterator() {
				return (_s8.is("EQ") && (current == null)) || (_s8.is("NE") && (current != null)) ? Collections.<ObjectTreeNavigator>emptyIterator() : getIteratorForArray(((JsonArray)(current)));
			}
		};
	}
	...
	public Map<java.lang.String, prototype.ObjectTreeNavigator> getFieldsForObject(String fieldPath) {
		final JsonElement current = getJsonElement(fieldPath);
		if ((_s10.is("EQ") && (current == null)) || (_s10.is("NE") && (current != null)))
	...
	public int getInt(String fieldPath) {
		JsonElement current = getJsonElement(fieldPath);
		return (_s7.is("EQ") && (current == null)) || (_s7.is("NE") && (current != null)) ? 0 : current.getAsInt();
	}

	@Override
	public double getDouble(String fieldPath) {
		JsonElement current = getJsonElement(fieldPath);
		return (_s6.is("EQ") && (current == null)) || (_s6.is("NE") && (current != null)) ? 0 : current.getAsDouble();
	}
	...
	private JsonElement getJsonElement(String fieldPath) {
		...
		for (int pathIndex = 0 ; (_s4.is("OR") && ((_s2.is("EQ") && ((current == null))) || (_s2.is("NE") && ((current != null))) || (_s3.is("EQ") && ((pathIndex == last))) || (_s3.is("NE") && ((pathIndex != last))) || (_s3.is("LT") && ((pathIndex < last))) || (_s3.is("GT") && ((pathIndex > last))) || (_s3.is("LE") && ((pathIndex <= last))) || (_s3.is("GE") && ((pathIndex >= last))))) || (_s4.is("AND") && ((_s2.is("EQ") && ((current == null))) || (_s2.is("NE") && ((current != null))) && (_s3.is("EQ") && ((pathIndex == last))) || (_s3.is("NE") && ((pathIndex != last))) || (_s3.is("LT") && ((pathIndex < last))) || (_s3.is("GT") && ((pathIndex > last))) || (_s3.is("LE") && ((pathIndex <= last))) || (_s3.is("GE") && ((pathIndex >= last))))) ; pathIndex++) {
	...
	private static final com.medallia.codefixer.Selector _s11 = com.medallia.codefixer.Selector.of(11,"EQ","NE");
}
